<?PHP 
    function theme_enqueue_styles(){
        ...
        wp_enqueue_style('style', get_template_directory_uri(), array('ress'), false, 'all');
        wp_enqueue_style('my_styles', get_template_directory_uri().'/css/mystyle.css', array('style'), '', 'all');
